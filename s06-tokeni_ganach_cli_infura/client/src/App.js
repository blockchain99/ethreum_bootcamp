...
//   }
 ...
 state = { loaded: false , kycAddress: "", show: false , tokenSaleAddress: "", userTokens: 0};
...
componentDidMount = async () => {
  ...
  // The web3.eth.Contract object makes it easy to interact with 
  // smart contracts on the ethereum blockchain. 
  // When you create a new contract object you give it the json interface 
  // of the respective smart contract and web3 will auto convert 
  // all calls into low level ABI calls over RPC for you.

  // This allows you to interact with smart contracts as if 
